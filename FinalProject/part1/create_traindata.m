function [labels_airplane, labels_car, labels_face, labels_motorbike, train_data] = create_traindata(path...
    , paths, last_image, no_of_train_images, imagefiles, color_scheme, type_of_sift, kmeans_centers, vocab_size)

labels_airplane = zeros(no_of_train_images*4, 1);
labels_car = zeros(no_of_train_images*4, 1);
labels_face = zeros(no_of_train_images*4, 1);
labels_motorbike = zeros(no_of_train_images*4, 1);
...
for i = 1:length(paths)
    ...
    for j = last_image+1:last_image+no_of_train_images
